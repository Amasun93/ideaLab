...
| 版本 | 日期 | 更新内容 |
|------|------|----------|
| v0.5.16 | 2026-07-02 | 新增顾问应答剧本(response_playbook.md),重构 Skill 架构,重命名赛事情报模块 |
| v0.5.15 | 2026-07-02 | 扩展校情索引(新增初中索引、高中索引、体制外学校索引、班型索引),澄清青创赛学校获奖数量用语 |
| v0.5.14 | 2026-07-02 | 新增校情蓝皮书知识库(5城市30+学校资料卡、校情索引、学校蓝皮书原始来源记录),文档化学校PDF提取工作流 |
| v0.5.13 | 2026-06-26 | 长三角AI奥林匹克获奖数据、3D打印营运营QA、教练面试预约表、公众号喜报链接等 |
...
- 高风险更新是否进入待确认。
- 是否有重复目录、孤立文件或过期别名。
- `第41届青创赛获奖数` 是否保持清晰含义，没有被弱化成"表格记录"。
