...
Use this reference when the user asks about 校情蓝皮书、学校校情、小升初校情、科创校情、三公/特色校/名校的科创规划、某城市或某学校的科创关注度、学校是否重视科创、以及适合怎样做 ideaLab 产品规划。
...
4. `data/school_intelligence_20260702.json` when structured fields are needed
5. `data/school_bluebook_sources_20260702.json` when source-batch confirmation is needed
